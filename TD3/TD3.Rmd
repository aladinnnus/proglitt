...
plot(df1$time, ylab="Time (seconds)", xlab="Measurement Number");

summary(df1$time);

boxplot(df1$time, ylab="Time (seconds)");

hist(df1$time, breaks=50, xlab="Time (seconds)", main="Histogram of Ping-Pong");
